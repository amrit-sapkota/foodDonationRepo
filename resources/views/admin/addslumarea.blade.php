						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0"><h4 class="text-secondary">Add Areas 
								...
								<div class="card-body">
									...
									<div class="d-grid gap-2">
										{{-- <a href="/admin/slumareas" class="btn btn-lg btn-primary">Add Area</a> --}}
										 <button type="submit" class="btn btn-lg btn-primary">Add Area</button> 
									</div>
									</form>
								</div>
							</div>
